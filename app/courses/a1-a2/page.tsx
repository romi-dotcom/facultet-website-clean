          ...
          <div className="flex flex-col gap-6 flex-1">
            ...
            <div className="bg-[#F0FDF4] border border-[#BBF7D0] rounded-xl p-5 px-6 flex flex-col gap-3.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[13px] font-bold text-[#16A34A]">What you&apos;ll achieve in 9 weeks</span>
              </div>
            ...
            <div className="flex flex-col gap-5 p-7 pb-6">
              ...
              <div className="flex flex-col gap-3.5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[13px] font-semibold text-[#1E293B]">9 weeks · 75 hours</span>
                </div>
                <div className="flex items-center gap-3">
...
/* ──────────────────────────────────────────────
   ...
   ────────────────────────────────────────────── */
const modules = [
  { num: "1", title: "Module 1 — A1 Consolidation", meta: "5 lessons · 15 hours · Weeks 1–2", pills: [{ label: "Review", color: "text-[#16A34A]", bg: "bg-[#F0FDF4]" }, { label: "Grammar", color: "text-[#2563EB]", bg: "bg-[#EFF6FF]" }], accent: false },
  { num: "2", title: "Module 2 — Expanding Communication (A1+)", meta: "5 lessons · 15 hours · Weeks 3–4", pills: [{ label: "Vocabulary", color: "text-[#16A34A]", bg: "bg-[#F0FDF4]" }, { label: "Conversation", color: "text-[#2563EB]", bg: "bg-[#EFF6FF]" }], accent: false },
  { num: "3", title: "Module 3 — Advanced Everyday Contexts (A2)", meta: "6 lessons · 18 hours · Weeks 5–6", pills: [{ label: "Daily life", color: "text-[#16A34A]", bg: "bg-[#F0FDF4]" }, { label: "Culture", color: "text-[#2563EB]", bg: "bg-[#EFF6FF]" }], accent: false },
  { num: "4", title: "Module 4 — Social & Professional Portuguese (A2)", meta: "5 lessons · 15 hours · Weeks 7–8", pills: [{ label: "Professional", color: "text-[#16A34A]", bg: "bg-[#F0FDF4]" }, { label: "Social", color: "text-[#2563EB]", bg: "bg-[#EFF6FF]" }], accent: false },
  { num: "5", title: "Module 5 — Exam Preparation & PLA Certificate (A2)", meta: "4 lessons · 12 hours · Week 9", pills: [{ label: "Mock exam", color: "text-[#16A34A]", bg: "bg-[#F0FDF4]" }, { label: "Final prep", color: "text-[#E85D26]", bg: "bg-[#FFF7ED]" }], accent: true },
];

const mobileModules = [
  { num: "1", title: "A1 Consolidation", meta: "5 lessons · Weeks 1–2", accent: false },
  { num: "2", title: "Expanding Communication (A1+)", meta: "5 lessons · Weeks 3–4", accent: false },
  { num: "3", title: "Advanced Everyday Contexts (A2)", meta: "6 lessons · Weeks 5–6", accent: false },
  { num: "4", title: "Social & Professional Portuguese (A2)", meta: "5 lessons · Weeks 7–8", accent: false },
  { num: "5", title: "Exam Prep & PLA Certificate (A2)", meta: "4 lessons · Week 9", accent: true },
];
          ...
          <div className="flex flex-col gap-6 w-[360px] shrink-0">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[15px] text-[#64748B] leading-[1.6]">
                25 lessons across 5 modules. Each lesson is ~3 hours — live, online, with homework and feedback.
              </p>
            </div>
            {/* Stats */}
            <div className="flex flex-col gap-3">
              {[
                ...
                { icon: Calendar, text: "9 weeks · Tue, Thu, Sat · 9–12" },
  ...
  return (
    <section id="faq" className="bg-[#F8FAFC] py-8 px-5 lg:py-20 lg:px-[120px]">
      ...
      <div className="lg:hidden flex flex-col gap-4 max-w-[1200px] mx-auto">
        ...
        {/* WhatsApp button */}
        <a href="https://api.whatsapp.com/send/?phone=351923296007&text=Hello%21+I%27d+like+to+learn+more+about+your+Portuguese+language+courses.&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" onClick={() => track("whatsapp_click", { page: "A1-A2 Course" })} className="flex items-center justify-center gap-2 bg-white border border-[#E2E8F0] rounded-lg py-3 px-5 w-full">
      ...
      <div className="hidden lg:flex flex-row gap-20 max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col gap-5 w-[360px] shrink-0">
          ...
          <a href="https://api.whatsapp.com/send/?phone=351923296007&text=Hello%21+I%27d+like+to+learn+more+about+your+Portuguese+language+courses.&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" onClick={() => track("whatsapp_click", { page: "A1-A2 Course" })} className="flex items-center justify-center gap-2 h-12 bg-white border border-[#E2E8F0] rounded-lg w-fit px-5">
            <MessageCircle className="w-4 h-4 text-[#25D366]" />
            <span className="text-sm font-semibold text-[#1E293B]">Ask on WhatsApp</span>
          </a>
        </div>
    ...
    <section id="enrol" className="bg-white py-8 px-5 lg:bg-[#F8FAFC] lg:py-20 lg:px-[120px]">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:items-center gap-3 lg:gap-6">
        ...
        <h2 className="lg:hidden text-[28px] font-extrabold text-[#1E293B] leading-[1.2] tracking-[-0.5px]">
          Enrol and get certified in 9 weeks
        </h2>
        {/* Desktop meta */}
      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="hidden lg:flex gap-10 justify-between">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex items-center gap-1.5"><Phone className="w-3.5 h-3.5 text-[#64748B]" /><span className="text-sm text-[#E2E8F0]">+351 923 296 007</span></div>
            <div className="flex items-center gap-1.5"><Mail className="w-3.5 h-3.5 text-[#64748B]" /><span className="text-sm text-[#1B8A7E]">lingua@facultet.school</span></div>
            ...
            <div className="flex items-center gap-1.5"><Timer className="w-3.5 h-3.5 text-[#64748B]" /><span className="text-[13px] text-[#64748B]">Mon–Fri 9:00–18:00 · Sat 10:00–14:00</span></div>
          </div>
          {/* Links */}
          <div className="flex flex-col gap-2.5">
            ...
            <a href="https://ola.facultet.school/public-offer" target="_blank" rel="noopener noreferrer" className="text-sm text-[#64748B] hover:text-[#94A3B8] transition-colors">Public Offer</a>
          </div>
          {/* Trust */}
          <div className="flex flex-col gap-3">
        ...
        <div className="lg:hidden flex flex-col gap-6">
          ...
          {/* Contacts */}
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-2"><Mail className="w-3.5 h-3.5 text-[#64748B]" /><span className="text-[13px] text-[#1B8A7E]">lingua@facultet.school</span></div>
            <div className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 text-[#64748B]" /><span className="text-[13px] text-[#E2E8F0]">+351 923 296 007</span></div>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <a href="https://ola.facultet.school/public-offer" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[#64748B] hover:text-[#94A3B8] transition-colors">Public Offer</a>
          </div>
        ...
        <div className="hidden lg:block">
          ...
          <div className="flex items-center justify-between pt-6">
            ...
            <span className="text-xs text-[#64748B]">Terms of Use · Privacy Policy · Cookies · <a href="https://ola.facultet.school/public-offer" target="_blank" rel="noopener noreferrer" className="hover:text-[#94A3B8] transition-colors">Public Offer</a></span>
          </div>
        </div>
      </div>
    </footer>
