    ...
    <section id="enrol" className="bg-white py-12 px-5 lg:bg-[#F8FAFC] lg:py-20 lg:px-[120px]">
      <div className="max-w-[1200px] mx-auto flex flex-col items-center gap-4 lg:gap-6">
        ...
        <div className="w-full max-w-[480px] bg-white rounded-[20px] border border-[#E2E8F0] shadow-[0_4px_24px_rgba(15,23,42,0.05)] p-6 lg:p-8 flex flex-col gap-3">
          ...
          <button className="flex items-center justify-center h-[52px] lg:h-14 bg-[#E85D26] rounded-full lg:rounded-lg text-[15px] font-bold text-white shadow-[0_2px_8px_rgba(232,93,38,0.19)]">
            Enrol Now
          </button>
          <div className="flex items-center justify-center gap-1.5">
