          ...
          <div className="w-[360px] shrink-0 bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_8px_24px_rgba(0,0,0,0.06)]">
            <div className="flex flex-col gap-5 p-7 pb-6">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="bg-[#FEF3C7] text-[#B45309] text-[10px] font-bold rounded-md px-2 py-0.5 whitespace-nowrap">−20% · Until April 7</span>
              </div>
              {/* Klarna */}
              ...
              <div className="flex flex-col gap-3.5">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[13px] font-semibold text-[#1E293B]">April 7 · May 5</span>
                </div>
                <div className="flex items-center gap-3">
  ...
  return (
    <div className="lg:hidden flex flex-col gap-4 bg-white px-5 pt-10 pb-8">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <span className="bg-[#FEF3C7] text-[#B45309] text-[11px] font-bold rounded-md px-2.5 py-1">−20% · Until April 7</span>
      </div>
      {/* Klarna */}
      <div className="flex items-center gap-2 bg-[#FFF0F8] rounded-lg px-3.5 py-2.5">
    ...
    <section className="bg-[#F8FAFC] py-16 px-5 lg:py-20 lg:px-[120px]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:gap-6">
          {/* Card 1 */}
          <div className="flex-1 bg-white rounded-2xl border border-[#E2E8F0] p-6 lg:p-7 relative overflow-hidden">
            ...
            <p className="text-sm text-[#475569] leading-[1.5] mb-4 lg:text-sm">
          ...
          {/* Card 3 */}
          <div className="flex-1 bg-[#0F766E] rounded-2xl p-6 lg:p-7 relative overflow-hidden">
